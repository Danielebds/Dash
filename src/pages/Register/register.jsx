    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-[#142630] via-cyan-800 to-[#142630]">
      <form onSubmit={handleSubmit} className="space-y-12 p-6 bg-white rounded-lg shadow-md w-full max-w-4xl">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-semibold leading-7 text-[#142630]">Cadastro</h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div className="sm:col-span-3">
            ...
            <input type="text" name="nome" id="nome" value={formData.nome} onChange={handleChange} className="mt-2 block w-full rounded-md border-0 py-1.5 bg-transparent text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#142630] sm:text-sm sm:leading-6" />
          </div>
          <div className="sm:col-span-3">
          ...
          <div className="sm:col-span-3">
            ...
            <button type="button" onClick={handleAddProgram} className="mt-2 text-[#142630]">+ Adicionar mais programas</button>
          </div>
          ...
          <div className="sm:col-span-3">
            ...
            <button type="button" onClick={handleAddResponsavel} className="mt-2 text-[#142630]">+ Adicionar mais responsáveis</button>
          </div>
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          <button type="button" className="rounded-md bg-[#142630] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
          ...
          <button type="button" onClick={handleAddResponsavel} className="rounded-md bg-[#142630] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            Adicionar Mais
          </button>
        </div>
